                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img width="160" src="{{ asset('storage/' . str_replace('public/', '', $data->photo)) }}" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Bio</th>
                                        ...
                                        <tr>
                                            <th>Salary Amount</th>
                                            <td><input value="{{$data->salary_amt}}" name="salary_amt" class="form-control" type="number" step="any" /></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
