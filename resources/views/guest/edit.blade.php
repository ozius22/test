                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Update Guest
                                <a href="{{url('admin/guest')}}" class="float-right btn btn-success btn-sm">View All</a>
                            </h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/guest/'.$data->id)}}">
                                    @csrf
                                    @method('put')
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <img width="200" src="{{ asset('storage/' . str_replace('public/', '', $data->photo)) }}" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Address</th>
