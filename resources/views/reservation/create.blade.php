                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Add Reservation
                                <a href="{{url('admin/reservation')}}" class="float-right btn btn-success btn-sm">View All</a>
                            </h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <form method="post" enctype="multipart/form-data" action="{{url('admin/reservation')}}">
                                    ...
                                    <table class="table table-bordered" >
                                        <tr>
                                            <th>Select Guest <span class="text-danger">*</span></th>
                                            <td>
                                        ...
                                        <tr>
                                            <th>Select Available Rooms <span class="text-danger">*</span></th>
                                            <td>
