    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/')}}">
                ...
                <div class="sidebar-brand-text mx-3">DEL LUNA</div>
            </a>
            ...
            <!-- CustomerMaster -->
            <li class="nav-item">
                <a class="nav-link @if(!request()->is('admin/guest*')) collapsed @endif" href="#" data-toggle="collapse" data-target="#CustomerMaster"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-fw fa-users"></i>
                    <span>Guests</span>
                </a>
                <div id="CustomerMaster" class="collapse @if(request()->is('admin/guest*')) show @endif" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{url('admin/guest')}}">View All</a>
                        <a class="collapse-item" href="{{url('admin/guest/create')}}">Add New</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{url('admin/testimonials')}}">
                    <i class="fas fa-hotel"></i>
                    <span>Guest Testimonials</span></a>
            </li>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Hotel Del Luna 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
